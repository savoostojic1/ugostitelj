      ...
      <div className="mx-auto max-w-6xl px-5 py-16 md:px-10 md:py-20">
        <div className="public-animate-in mx-auto max-w-2xl text-center">
          ...
          <h2 className="public-heading text-3xl md:text-4xl">
            Pogledajte sve naše jedinice
          </h2>
          <p className="mt-4 text-[15px] leading-relaxed text-[var(--public-muted)]">
            Istražite kompletan izbor smještaja i provjerite slobodne datume
            za svaku jedinicu posebno.
          </p>
          ...
          <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
            ...
            >
              ...
              {viewMode === "units" ? "Sakrij jedinice" : "Prikaži sve jedinice"}
            </button>
            <button
              type="button"
          ...
          <div className="mt-12">
            {loading ? (
              ...
              <div className="public-card mx-auto max-w-lg px-6 py-12 text-center">
                <p className="font-medium">Trenutno nema objavljenih jedinica</p>
              </div>
            ) : viewMode === "units" ? (
              <div
                className={cn(
                ...
                <p className="text-center text-sm text-[var(--public-muted)]">
                  ...
                  {count === 1
                    ...
                    : count >= 2 && count <= 4
                      ? "jedinice"
                      : "jedinica"}{" "}
                  · kliknite datume za rezervaciju
                </p>
